...
namespace RotaryClubManager.Infrastructure.Migrations
{
    ...
    [Migration("20250619111620_AddRotaryClubTable")]
    partial class AddRotaryClubTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RotaryClubManager.Domain.Entities.RotaryClub", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("JourReunion");

                    b.HasIndex("NumeroClub")
                        .IsUnique();

                    b.ToTable("RotaryClubs");
                });
            ...
            modelBuilder.Entity("RotaryClubManager.Domain.Entities.RotaryClub", b =>
                {
                    b.HasOne("RotaryClubManager.Domain.Entities.Club", "Club")
                        .WithOne()
                        .HasForeignKey("RotaryClubManager.Domain.Entities.RotaryClub", "ClubId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
