...
namespace RotaryClubManager.Infrastructure.Migrations
{
    ...
    [Migration("20250825144320_AddFormationModule")]
    partial class AddFormationModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RotaryClubManager.Domain.Entities.Commission", b =>
                {
                    ...
                    b.Property<string>("RoleEtResponsabilite")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("RotaryClubManager.Domain.Entities.Formation.BadgeFormation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DocumentFormationId")
                        .HasMaxLength(450)
                    ...
                    b.HasIndex("DateObtention");

                    b.HasIndex("MembreId");

                    b.HasIndex("Type");

                    b.HasIndex("MembreId", "Type", "DocumentFormationId");

                    b.ToTable("BadgesFormation");
                });

            modelBuilder.Entity("RotaryClubManager.Domain.Entities.Formation.ChunkDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("DocumentFormationId")
                        .HasColumnType("uuid");

                    b.Property<int>("IndexChunk")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DocumentFormationId");

                    b.HasIndex("IndexChunk");

                    b.HasIndex("DocumentFormationId", "IndexChunk");

                    b.ToTable("ChunksDocument");
                });

            modelBuilder.Entity("RotaryClubManager.Domain.Entities.Formation.DocumentFormation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DateUpload");

                    b.HasIndex("UploadePar");

                    b.HasIndex("ClubId", "EstActif");

                    b.ToTable("DocumentsFormation");
                });

            modelBuilder.Entity("RotaryClubManager.Domain.Entities.Formation.QuestionFormation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("ChunkDocumentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ChunkDocumentId");

                    b.HasIndex("Difficulte");

                    b.HasIndex("SessionFormationId");

                    b.ToTable("QuestionsFormation");
                });

            modelBuilder.Entity("RotaryClubManager.Domain.Entities.Formation.ReponseUtilisateur", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("QuestionFormationId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("TempsReponseMs")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("DateReponse");

                    b.HasIndex("QuestionFormationId");
            ...
            modelBuilder.Entity("RotaryClubManager.Domain.Entities.Formation.SessionFormation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MembreId", "DocumentFormationId");
            ...
            modelBuilder.Entity("RotaryClubManager.Domain.Entities.RubriqueBudget", b =>
                {
                    ...
                    b.HasIndex("ClubId", "MandatId", "MontantRealise")
                    ...
                    b.HasIndex("ClubId", "MandatId", "PrixUnitaire", "Quantite")
                    ...
                    b.ToTable("RubriquesBudget", (string)null);
                });
            ...
            modelBuilder.Entity("RotaryClubManager.Domain.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("DateAnniversaire")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("RotaryClubManager.Domain.Entities.Formation.ChunkDocument", b =>
                {
                    b.HasOne("RotaryClubManager.Domain.Entities.Formation.DocumentFormation", "DocumentFormation")
                        .WithMany("Chunks")
                        .HasForeignKey("DocumentFormationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DocumentFormation");
                });
            ...
            modelBuilder.Entity("RotaryClubManager.Domain.Entities.Formation.DocumentFormation", b =>
                {
                    ...
                    b.HasOne("RotaryClubManager.Domain.Identity.ApplicationUser", "Uploadeur")
                        .WithMany()
                        .HasForeignKey("UploadePar")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Club");

                    b.Navigation("Uploadeur");
                });

            modelBuilder.Entity("RotaryClubManager.Domain.Entities.Formation.QuestionFormation", b =>
                {
                    b.HasOne("RotaryClubManager.Domain.Entities.Formation.ChunkDocument", "ChunkDocument")
                        .WithMany("Questions")
                        .HasForeignKey("ChunkDocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RotaryClubManager.Domain.Entities.Formation.SessionFormation", "SessionFormation")
                        .WithMany("Questions")
                        .HasForeignKey("SessionFormationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChunkDocument");
            ...
            modelBuilder.Entity("RotaryClubManager.Domain.Entities.Formation.ReponseUtilisateur", b =>
                {
                    b.HasOne("RotaryClubManager.Domain.Entities.Formation.QuestionFormation", "QuestionFormation")
                        .WithMany("Reponses")
                        .HasForeignKey("QuestionFormationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RotaryClubManager.Domain.Entities.Formation.SessionFormation", null)
                        .WithMany("Reponses")
                        .HasForeignKey("SessionFormationId");

                    b.Navigation("QuestionFormation");
                });
